...
export class AvaliacoesComponent {
  ...
  reviews = [
    ...
    { id: 9, comment: 'Fiz experiências com outras pizzas de outros lugares e descobri, estamos viciados na Sorelli. Parabéns pelo capricho em cada detalhe, amo a pizza de vocês e super recomendo!! Sem dúvidas a melhor.' },
    ...
    { id: 17, comment: 'Eu acho que vocês são a única pizzaria que tem essa abertura com os clientes, vocês são diferenciados, vocês fazem seus trabalhos com excelência!' },
    { id: 18, comment: 'Pedi a “americana” hoje pra experimentar, maravilhosaaaa! Sou suspeita a falar porque sou fã de vocês. Melhor pizza da cidade!' },
    { id: 19, comment: 'A pizza de frango com catupiry da Sorelli tá no meu top 3! Bem temperada e super recheada. Sempre fico satisfeita.' },
    { id: 20, comment: 'Merecem toda credibilidade. MEU DEUS!!! Que pizza deliciosa!! Eu amei. Nunca comi uma pizza assim, juro! Fico feliz por poder comer algo tão gostoso.' },
    { id: 21, comment: 'A app tá ótimo, gostei demais. E a pizza de brigadeiro tava uma delícia.' },
    { id: 22, comment: 'Pizza maravilhosa!!! A melhor da cidade, não decepciona nunca! Padrão de qualidade incrível.' },
    { id: 23, comment: 'Rapaz! Maravilhosa. Nunca comi uma pizza igual a essa, amei, quase não deixo pra galera! Delícia! Vocês estão de parabéns!' },
    { id: 24, comment: 'A pizza estava uma delícia, sem dúvidas a melhor da cidade disparada.' },
    { id: 25, comment: 'Tudo certinho. Inclusive pude notar que o camarão veio bem tratado e limpo. Pode parecer bobagem, mas já vi pratos que vieram sujos só pra não cortar o camarão.' },
    { id: 26, comment: 'Gostaria de parabenizar o trabalho realizado por vocês!!! Excelente a pizza feita por vocês. A última pizza estava muito saborosa... Com uma massa leve, crocante, bem recheada... Um sabor único e peculiar que somente vocês sabem fazer. Graças a Deus que deu a vocês o dom gastronômico... Mas enfim, parabéns!!!!' },
    { id: 27, comment: 'Poxa, parabéns viu, pizza maravilhosa, chega quentinha, bem recheada, muito boa mesmo, a cada vez que eu como gosto mais ainda.' },
    { id: 28, comment: 'Obrigado a vocês pelo amor e carinho com os seus clientes. Deus abençoe a todos!' },
    { id: 29, comment: 'Sorelli, super satisfeita com a minha compra. A entrega foi rápida, pizza chegou quentinha, saborosa como sempre. Obrigada!' },
    { id: 30, comment: 'Amei esse aplicativo, vocês arrasaram.' },
    { id: 31, comment: 'Cada dia vocês me surpreendem com o sabor e a qualidade, como sempre perfeita. Sem falar no atendimento, vocês estão de parabéns, a melhor de Catu sem dúvidas!' },
    { id: 32, comment: 'A pizza estava uma delíciaaaa, a melhor que já comi, vocês melhoraram ainda mais, parabéns!' },
    { id: 33, comment: 'Tudo maravilhoso, não tenho o que falar, sempre me surpreendo. Melhor da região, tem que respeitar. Obrigado pela pizza magnífica!' },
    { id: 34, comment: 'Essa é a melhor da cidade, qualidade 100%.' },
    { id: 35, comment: 'Se essa não é a melhor pizza do mundo eu não sei qual é! Maravilhosa como sempre!' },
    { id: 36, comment: 'A melhor que temos. Obrigadaaa, e amei o super desconto!' },
    { id: 37, comment: 'O que dizer? Sem palavras, melhor da região! Como sempre maravilhoso e muito saboroso, muito obrigada e a partir de hoje vou pedir pelo App, fácil e prático.' },
    { id: 38, comment: 'Melhor pizzaria que eu já comprei, nota 10!' },
    { id: 39, comment: 'Não tem como não gostar, melhor de Catu!' },
  ];
